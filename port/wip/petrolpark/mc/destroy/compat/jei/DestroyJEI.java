...
import petrolpark.mc.destroy.compat.jei.animation.ArcFurnaceIcon;
...
import petrolpark.mc.destroy.compat.jei.category.CartographyTableCategory.CartographyTableRecipe;
...
import petrolpark.mc.destroy.compat.jei.category.MixableExplosiveCategory.MixableExplosiveRecipe;
...
import petrolpark.mc.destroy.compat.jei.category.VatMaterialCategory.VatMaterialRecipe;
import petrolpark.mc.destroy.compat.jei.recipemanager.ChemicalSpeciesRecipeManagerPlugin;
import petrolpark.mc.destroy.compat.jei.recipemanager.FireproofingRecipeManagerPlugin;
import petrolpark.mc.destroy.compat.jei.recipemanager.ItemReverseReactionRecipeManagerPlugin;
...
public class DestroyJEI implements IModPlugin {
     ...
     * Create's Recipe Types are not exposed by default, meaning we have to access them through a {@link petrolpark.mc.destroy.mixin.compat.jei.CreateRecipeCategoryMixin mixin} and store them here.
     */ 
     ...
     * This does not include {@link petrolpark.mc.destroy.chemistry.legacy.LegacyReaction Reactions}.
     */
