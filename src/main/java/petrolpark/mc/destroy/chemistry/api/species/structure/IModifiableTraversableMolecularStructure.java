...
import petrolpark.mc.destroy.chemistry.api.species.structure.IMolecularStructure.IAtomConnection;
import petrolpark.mc.destroy.chemistry.api.species.structure.IMolecularStructure.IAtomConnections;
...
public interface IModifiableTraversableMolecularStructure<S extends IModifiableTraversableMolecularStructure<? super S, A, N, C, CS>, A extends IAtom<? extends N>, N extends INuclide, C extends IAtomConnection<? extends A, ? extends N>, CS extends IAtomConnections<? extends A, ? extends N, ? extends C>> extends ITraversableMolecularStructure<A, N, C, CS>, IModifiableMolecularStructure<S, A, N, C, CS> {
     ...
     * @since Destroy 0.1.0
     * @author petrolpark
     * @see IModifiableMolecularStructure#connect(IAtom, IAtom, petrolpark.mc.destroy.chemistry.api.species.structure.IModifiableMolecularStructure.IAtomConnectionFactory) Connecting arbitrary IAtoms
     */
