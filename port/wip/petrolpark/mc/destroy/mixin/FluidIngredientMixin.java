...
import petrolpark.mc.destroy.core.recipe.ingredient.fluid.MixtureFluidIngredientSubType;
import petrolpark.mc.destroy.mixin.accessor.FluidIngredientAccessor;
import com.simibubi.create.foundation.fluid.FluidIngredientOld;
import com.simibubi.create.foundation.fluid.FluidIngredientOld.FluidStackIngredient;
import com.simibubi.create.foundation.fluid.FluidIngredientOld.FluidTagIngredient;
...
public abstract class FluidIngredientMixin {
	...
	/**
	 * Overwriting of {@link com.simibubi.create.foundation.fluid.FluidIngredientOld#isFluidIngredient FluidIngredientOld} to
	 * say {@link petrolpark.mc.destroy.core.recipe.ingredient.fluid.MoleculeFluidIngredient Molecule ingredients}
	 * are valid.
	 */
	...
	/**
	 * Overwritten but mostly copied from {@link com.simibubi.create.foundation.fluid.FluidIngredientOld#deserialize FluidIngredientOld}.
	 * This deserializes {@link petrolpark.mc.destroy.core.recipe.ingredient.fluid.MoleculeFluidIngredient Molecule ingredients}.
	 */
    @Overwrite(remap = false)
    public static FluidIngredientOld deserialize(@Nullable JsonElement je) {

		if (je == null) return FluidIngredientOld.EMPTY;
		...
		FluidIngredientOld ingredient = null;
		if (json.has(fluidMemberName)) {
			ingredient = new FluidIngredientOld.FluidStackIngredient();
		} else if (json.has(fluidTagMemberName)) {
			ingredient = new FluidIngredientOld.FluidTagIngredient();
		//
	...
	public void write(FriendlyByteBuf buffer) {
		FluidIngredientOld $this = (FluidIngredientOld)(Object)this;
	...
	@Overwrite(remap = false)
	public static FluidIngredientOld read(FriendlyByteBuf buffer) {
