...
public class MixedExplosiveScreen extends AbstractSimiContainerScreen<MixedExplosiveMenu> {
    ...
    protected void init() {
        ...
        // PORT (1.21.1): the JEI "view mixable explosives" button is dropped along with compat/jei
        // (not ported, see HANDOFF.md rule 6). Re-add once MixableExplosiveCategory comes back.
    };
