...
import petrolpark.mc.destroy.mixin.accessor.ValueSettingsScreenAccessor;
...
public class BetterValueSettingsScreen extends ValueSettingsScreen {
    ...
    protected void saveAndClose(double mouseX, double mouseY) {
		...
		CatnipServices.NETWORK.sendToServer(new ValueSettingsPacket(pos, closest.row(), closest.value(), hand, null, sideAccessed,
