...
public abstract class GenericReaction {
     ...
     * The {@link petrolpark.mc.destroy.chemistry.legacy.LegacyFunctionalGroupType groups} of the resultant {@link petrolpark.mc.destroy.chemistry.legacy.LegacySpecies#isNovel novel}
     * {@link petrolpark.mc.destroy.chemistry.legacy.LegacySpecies Molecules} are used to determine what functional groups this Generic Reaction produces.
     */
    @NotNull
    ...
    /**
     * Instantiate a {@link petrolpark.mc.destroy.chemistry.api.error.ChemistryException Chemistry Exception}. These kinds of exceptions are
