...
import petrolpark.mc.destroy.core.bettervaluesettings.BetterValueSettingsScreen;
...
public class TransferFluidScreen extends BetterValueSettingsScreen {
    ...
    protected void saveAndClose(double mouseX, double mouseY) {
		...
		CatnipServices.NETWORK.sendToServer(new TransferFluidPacket(pos, sideAccessed, hand, blockToItem, closest.value()));
		onClose();
    };
