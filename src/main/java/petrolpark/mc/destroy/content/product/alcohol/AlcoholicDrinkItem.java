...
public class AlcoholicDrinkItem extends DrinkItem {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entityLiving) {
        ...
        if (!level.isClientSide) {
            if (DestroySubstancesConfigs.alcoholEnabled()) DestroyMobEffects.increaseEffectLevel(entityLiving, DestroyMobEffects.INEBRIATION, strength, DestroyConfigs.server().substances.inebriationDuration.get());
            DestroyMobEffects.increaseEffectLevel(entityLiving, DestroyMobEffects.FULL_BLADDER, strength, DestroyConfigs.server().substances.inebriationDuration.get());
        };
